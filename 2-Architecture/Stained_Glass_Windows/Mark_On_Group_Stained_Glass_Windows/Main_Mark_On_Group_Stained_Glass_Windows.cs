...
namespace WPFApplication.Mark_On_Group_Stained_Glass_Windows
{
    ...
    public class Main_Mark_On_Group_Stained_Glass_Windows : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                Revit_Document_Mark_On_Group_Stained_Glass_Windows.Initialize(commandData);
                ...
                Filtered_Mark_On_Group_Stained_Glass_Windows filtered_Parameter_On_Group_Stained_Glass_Windows = new Filtered_Mark_On_Group_Stained_Glass_Windows();
